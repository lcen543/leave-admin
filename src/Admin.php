...
namespace Leave\Admin;

use Closure;
use Leave\Admin\Controllers\AuthController;
use Leave\Admin\Layout\Content;
use Leave\Admin\Traits\HasAssets;
use Leave\Admin\Widgets\Navbar;
...
class Admin
{
    ...
    /**
     * Returns the long version of leave-admin.
     *
     * @return string The long application version
     */
    public static function getLongVersion()
    {
        return sprintf('leave-admin <comment>version</comment> <info>%s</info>', self::VERSION);
    }
     ...
     * @param Closure $callable
     *
     * @return \Leave\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \Leave\Admin\Widgets\Navbar
     */
    ...
    public function registerAuthRoutes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('Leave\Admin\Controllers')->group(function ($router) {
